...
const App = ()=>{
    ...
    setTimeout(() => {
      axios.get("http://localhost:3200/cars?carNumber=aa-3214").then(res=>{
...
return (
  <>
  <Helmet>
    <title>AcciGone</title>
    <meta name="description" content="AcciGone is a platform for people to find and share accident information." />
